...
class ChatRepository @Inject constructor(
    ...
    suspend fun sendMessage(auth:String, myEmail: String, other: User, message: Message): List<Message>? {
        ...
        if(currentChatRoomData == null) {
            val newChatRoom = ChatRoom(me = myEmail, other = other, messages = listOf(message), chatCreatedAt = currentTime)
            return newChatRoom.messages
        } else {
